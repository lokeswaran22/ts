...
const app = express();
const PORT = process.env.PORT || 3006; // Using different port to avoid conflict
...
async function initDb() {
    try {
        ...
        await run(`CREATE TABLE IF NOT EXISTS deleted_activities (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            original_id INTEGER,
            dateKey TEXT,
            employeeId TEXT,
...
app.post('/api/login', async (req, res) => {
    ...
    try {
        ...
        let employeeId = null;
        if (role === 'employee') {
            const employee = await get('SELECT id FROM employees WHERE name = ?', [username]);
...
initDb().then(() => {
    app.listen(PORT, '0.0.0.0', () => {
        ...
        console.log(`\n🚀 Modular Architecture Server (Simplified)`);
        console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
        console.log(`\n📍 Local access:`);
        ...
        console.log('\n✅ Database: SQLite');
        console.log('✅ Architecture: Simplified Modular');
        console.log('✅ Backward Compatible: 100%');
        console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    });
});
